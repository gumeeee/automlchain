...
# Setup output
output_dir = "outputs/checkpoints/local_mac_test"
os.makedirs(output_dir, exist_ok=True)

# Write job metadata
with open(os.path.join(output_dir, "job_info.json"), "w") as f:
    json.dump({
        "job_id": "local_mac_test",
        "status": "running",
        "start_time": "2026-07-16 17:35:08",
    }, f, indent=2)
...
def main():
    print(f'Starting training job: local_mac_test')
    print(f'Model: TinyLlama/TinyLlama_v1.1')
